 ...
 * @LastEditTime: 2022-04-07 15:12:30
...
//   Vue.config.globalProperties.$kdy.px2vw = (px: number): string =>
//     `${(px / config.layoutWidth) * 100}vw`;
...
//   // 数字格式化
//   Vue.config.globalProperties.$kdy.numFormat = (
//     num: number,
//     lang: string = "zh"
//   ): string => {
...
//    * @returns {*|string}
//    */
//   Vue.config.globalProperties.$kdy.getAssetsImages = (name: string): string => {
//     return new URL(`/src/assets/${name}`, import.meta.url).href;
//   };
// };
