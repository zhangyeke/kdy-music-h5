 ...
 * @LastEditTime: 2023-02-08 16:40:15
 ...
 * @return {*}
 */
export const getSongListAll = <Param>(param:Param) => axios.get(`/playlist/track/all${tool.obj2str(param)}`);
 ...
 * @return {*}
 */
export const getSongListDetail = <Param>(param:Param) => axios.get(`/playlist/detail${tool.obj2str(param)}`);
 ...
 * @return {*}
 */
export const handlePlaylist = <Param>(param:Param) => axios.get(`/playlist/tracks${tool.obj2str(param)}`);
